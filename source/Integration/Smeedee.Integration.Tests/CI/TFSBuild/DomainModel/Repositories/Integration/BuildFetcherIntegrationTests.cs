...
using Smeedee.IntegrationTests.CI.TFSBuild.DomainModel.Repositories;
...
namespace Smeedee.IntegrationTests.CI.TFSBuild.DomainModel.Repositories.Integration
{
