...
namespace APD.IntegrationTests.Database.DomainModel.Repositories.ProjectInfoServerPersisterSpecs
{
    [TestFixture]
    public class When_saving : Shared
    {
        ...
        {
            var persister = new GenericDatabaseRepository<ProjectInfoServer>(sessionFactory);
