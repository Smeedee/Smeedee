...
{
    public class SourceControlTask : TaskBase
    {
        ...
        public SourceControlTask(IRepository<Changeset> changesetDbDatabase, 
        ...
        public override void Execute()
        {
            ...
            if (vcsConfiguration != null)
            {
                ...
                throw new TaskConfigurationException("Version Control System not configured");
        }
    }
}
