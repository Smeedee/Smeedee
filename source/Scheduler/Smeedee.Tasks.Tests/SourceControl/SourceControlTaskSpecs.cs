...
namespace Smeedee.TaskTests.SourceControl.SourceControlTaskSpecs
{

    public class Shared
    {
        protected static SourceControlTask SourceControlTask;
        ...
        protected class DefaultTask : TaskBase
        {
        ...
        protected Context sourceControlTask_is_created = () =>
        {
            ...
            if (configurationRepositoryMock == null)
                configurationRepositoryMock = new Mock<IRepository<Configuration>>();
            ...
            SourceControlTask = new SourceControlTask(changesetDbRepository.Object,
    ...
    public class when_spawned : Shared
    {
        ...
        public void should_override_default_name()
        {
            ...
            Scenario.StartNew(this, scenario =>
            {
                ...
                scenario.Then("the Task does not have the default Task name", () =>
                {
                    string defaultName = defaultTask.Name;
                    SourceControlTask.Name.ShouldNotBe(defaultName);
                });
            });
        }
    }
        ...
        public void Assure_exception_is_thrown()
        {
            Scenario.StartNew(this, scenario =>
            {
                scenario.Given(Configuration_Repository_does_not_contain_VCS_config).
                    And(sourceControlTask_is_created);
