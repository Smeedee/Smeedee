...
using Smeedee.Tasks.FileImport;
...
namespace Smeedee.TaskTests.FileImport.FileImportTaskSpecs
{
    public class Shared : ScenarioClass
    {
        ...
        private static FileImportTask _task;
        ...
        {
            _task = new FileImportTask(fileSystemServiceMock.Object,
    ...
    public class When_spawing : Shared
    {
        ...
        public void Setup()
        {
            Scenario("When spawning FileImportTask");
            Given("Task is not created");
            When("spawning");
        }
        ...
        public void Assure_FileSystem_service_obj_is_validated()
        {
            Then("assure FileSystem service obj is validated", () =>
                this.ShouldThrowException<ArgumentNullException>(() =>
                    new FileImportTask(null, null, null), ex => { }));
        }
        ...
        public void Assure_FileImportQueue_service_obj_is_validated()
        {
            Then("assure FileImportQueue service obj is validated", () =>
                this.ShouldThrowException<ArgumentNullException>(() =>
                    new FileImportTask(fileSystemServiceMock.Object, null, null), ex => { }));
        }
        ...
        public void Assure_FileProcessorFactory_obj_is_validated()
        {
            Then("assure FileProcessorFactory obj is validated", () =>
                this.ShouldThrowException<ArgumentNullException>(() =>
                    new FileImportTask(fileSystemServiceMock.Object, fileImportQueueService.Object, null), ex => { }));
        }
    }
    ...
    public class When_dispatched : Shared
    {
        ...
        public void Setup()
        {
            Scenario("When FileImportTask is harvest");
