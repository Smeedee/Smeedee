...
namespace Smeedee.TaskTests.ProjectInfo
{
    public class Shared
    {
        protected static TFSProjectInfoTask Task;
        ...
        protected static Mock<IAssembleRepositoryForTasks<ProjectInfoServer>> repositoryFactoryMock;
        protected static List<ProjectInfoServer> SavedProjectInfoServers;

        #region TaskMock
        private class MockTFSProjectInfoTask :  TFSProjectInfoTask
        {
            protected IAssembleRepositoryForTasks<ProjectInfoServer> repositoryFactoryMock;
        ...
        protected Context a_ProjectInfoTask_is_created = () =>
        {
            ...
            repositoryFactoryMock = new Mock<IAssembleRepositoryForTasks<ProjectInfoServer>>();

            repositoryFactoryMock.Setup(r => r.Assemble(It.IsAny<TaskConfiguration>())).
            ...
            var piConfig = new TaskConfiguration
                               {
                                   DispatchInterval = (int)new TimeSpan(0, 20, 0).TotalMilliseconds,
            ...
            Task = new MockTFSProjectInfoTask(repositoryFactoryMock.Object, databasePersister.Object, piConfig);
        };
    ...
    public class when_created : Shared
    {
        ...
        public void should_be_instanced()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                scenario.Then("instance exists", () => Task.ShouldNotBeNull());
            });
        }
        ...
        [Test]
        public void should_have_a_name_other_than_the_default()
        {
            Scenario.StartNew(this, scenario =>
            {
                scenario.Given(a_ProjectInfoTask_is_created);
                scenario.When("instance is accessed");
                scenario.Then("the Task has name other than the default", () =>
                {
                    Task.Name.ShouldNotBe("Default Task Name");
                });
            });
        }
