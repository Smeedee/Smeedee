...
using Smeedee.Tasks.CI.TeamFoundationServerCITask;
using Smeedee.Tasks.Framework;
using TinyBDD.Dsl.GivenWhenThen;
using TinyBDD.Specification.NUnit;

namespace Smeedee.Tasks.Tests.CI.TFS
{
    [TestFixture]
    public class When_spawned :Shared
    {
        ...
        {
            Then(Task.ShouldBeInstanceOfType<TaskBase>);
        }

        [Test]
        public void assure_task_name_is_set()
        {
            Then(Task.Name.ShouldNotBeNull);
        }
    }
    ...
    public class When_spawned_with_null_objects : Shared
    {
        ...
        public void assure_exception_is_thrown()
        {
            ...
            Then("assure ArgumentNullException is thrown", () =>
                    this.ShouldThrowException<ArgumentNullException>(() =>
                        new TeamFoundationServerCITask(null, null), ex => { }));
        }
        [Test]
        public void assure_exception_for_null_IPersistRepository_is_thrown()
        {
            Then("assure ArgumentNullException is thrown", () =>
                    this.ShouldThrowException<ArgumentNullException>(() =>
                        new TeamFoundationServerCITask(null, config.Object), ex => { }));
        }
        ...
        public void assure_exception_for_null_TaskConfig_is_thrown()
        {
            Then("assure ArgumentNullException is thrown", () =>
                    this.ShouldThrowException<ArgumentNullException>(() =>
                        new TeamFoundationServerCITask(dataPersisterMock.Object, null), ex => { }));
        }
    }
    ...
    public class Shared : ScenarioClass
    {
        ...
        protected static TeamFoundationServerCITask Task;
        ...
        protected Context task_is_created_with_config_entries = () =>
        {
            ...
            Task = new TeamFoundationServerCITask(dataPersisterMock.Object, config.Object);
        };
