...
{
    public class ContinuousIntegrationModule : VisibleModule<CIViewModel, CIView, CIController>
    {
        private const long REFRESH_INTERVAL = 1000 * 10; // ms * sec * min

        public ContinuousIntegrationModule(IUnityContainer iocContainer)
            : base(iocContainer){}
        ...
        protected override void ConfigureIocContainer()
        {
            ...
            localIocContainer.RegisterType<IInvokeBackgroundWorker<IEnumerable<CIProject>>, AsyncClient<IEnumerable<CIProject>>>();
