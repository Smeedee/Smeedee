...
namespace APD.Client.Widget.CI.Tests.ViewModels.CINotifierSpecs
{
    public class Shared
    {
        ...
        {
            ciViewModel = new CIViewModel(new NoUIInvocation());
            var projectInfoViewModel = new ProjectInfoViewModel(new NoUIInvocation());
            var buildViewModel = new BuildViewModel(new NoUIInvocation());
            

            projectInfoViewModel.LatestBuild = buildViewModel;
            ciViewModel.Data.Add(projectInfoViewModel);

            viewModel = new CINotifierViewModel(ciViewModel, new NoUIInvocation());
        };
        ...
        protected Context the_object_is_created_with_buildViewModel_status_successfull = () =>
        {
            ciViewModel = new CIViewModel(new NoUIInvocation());
            var projectInfoViewModel = new ProjectInfoViewModel(new NoUIInvocation());
            var latestBuild = new BuildViewModel(new NoUIInvocation());
    ...
    public class When_spawned : Shared
    {
        ...
        public void Should_have_default_constructor()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                {
                    var viewModel = new CINotifierViewModel(new NoUIInvocation());
