...
{
    public class TopCommitersModule
        : VisibleModule<BindableViewModel<CodeCommiterViewModel>, TopCommiters, TopCommitersController>
    {
        private const long REFRESH_INTERVAL = 1000 * 60 * 2; // ms * sec * min

        public TopCommitersModule(IUnityContainer globalIocContainer)
