...
namespace Smeedee.Client.Framework.SL.Tests.Converters
{
    ...
    public class BoolToVisibilityConverterSpecs
    {
        ...
        [TestMethod]
        public void Assert_true_is_converted_to_Visible()
        {
        ...
        [TestMethod]
        public void Assert_false_is_converted_to_Collapsed()
        {
            Assert.AreEqual(Visibility.Collapsed, _converter.Convert(false, typeof(Visibility), null, CultureInfo.CurrentCulture));
        }

        [TestMethod]
        public void Assert_Visible_is_converted_back_to_true()
        {
            Assert.IsTrue((bool)_converter.ConvertBack(Visibility.Visible,typeof(bool),null, CultureInfo.CurrentCulture));
        }

        [TestMethod]
        public void Assert_Collapsed_is_converted_back_to_false()
        {
            Assert.IsFalse(
