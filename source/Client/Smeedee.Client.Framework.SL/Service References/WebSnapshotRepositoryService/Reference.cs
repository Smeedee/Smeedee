...
namespace Smeedee.Client.Framework.SL.WebSnapshotRepositoryService {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="WebSnapshotSpecification", Namespace="http://schemas.datacontract.org/2004/07/Smeedee.DomainModel.WebSnapshot")]
    public partial class WebSnapshotSpecification : Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot>, System.ComponentModel.INotifyPropertyChanged {
    ...
    public interface WebSnapshotRepositoryService {
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotSpecification))]
        System.IAsyncResult BeginGet(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot> specification, System.AsyncCallback callback, object asyncState);
        
        Smeedee.DomainModel.WebSnapshot.WebSnapshot[] EndGet(System.IAsyncResult result);
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://smeedee.org/WebSnapshotRepositoryService/Save", ReplyAction="http://smeedee.org/WebSnapshotRepositoryService/SaveResponse")]
        System.IAsyncResult BeginSave(Smeedee.DomainModel.WebSnapshot.WebSnapshot[] webSnapshots, System.AsyncCallback callback, object asyncState);
    ...
    public partial class GetCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public Smeedee.DomainModel.WebSnapshot.WebSnapshot[] Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((Smeedee.DomainModel.WebSnapshot.WebSnapshot[])(this.results[0]));
            }
        }
    }
    ...
    public partial class WebSnapshotRepositoryServiceClient : System.ServiceModel.ClientBase<Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService>, Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService {
        ...
        System.IAsyncResult Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService.BeginGet(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot> specification, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGet(specification, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Smeedee.DomainModel.WebSnapshot.WebSnapshot[] Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService.EndGet(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGet(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot> specification = ((Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot>)(inValues[0]));
            return ((Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService)(this)).BeginGet(specification, callback, asyncState);
        }
        
        private object[] OnEndGet(System.IAsyncResult result) {
            Smeedee.DomainModel.WebSnapshot.WebSnapshot[] retVal = ((Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService)(this)).EndGet(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetAsync(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot> specification) {
            this.GetAsync(specification, null);
        }
        
        public void GetAsync(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot> specification, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService.BeginSave(Smeedee.DomainModel.WebSnapshot.WebSnapshot[] webSnapshots, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginSave(webSnapshots, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService.EndSave(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginSave(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Smeedee.DomainModel.WebSnapshot.WebSnapshot[] webSnapshots = ((Smeedee.DomainModel.WebSnapshot.WebSnapshot[])(inValues[0]));
            return ((Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService)(this)).BeginSave(webSnapshots, callback, asyncState);
        }
        
        private object[] OnEndSave(System.IAsyncResult result) {
            ((Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService)(this)).EndSave(result);
            return null;
        }
        ...
        public void SaveAsync(Smeedee.DomainModel.WebSnapshot.WebSnapshot[] webSnapshots) {
            this.SaveAsync(webSnapshots, null);
        }
        
        public void SaveAsync(Smeedee.DomainModel.WebSnapshot.WebSnapshot[] webSnapshots, object userState) {
            ...
            base.InvokeAsync(this.onBeginSaveDelegate, new object[] {
                        webSnapshots}, this.onEndSaveDelegate, this.onSaveCompletedDelegate, userState);
        }
        ...
        private class WebSnapshotRepositoryServiceClientChannel : ChannelBase<Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService>, Smeedee.Client.Framework.SL.WebSnapshotRepositoryService.WebSnapshotRepositoryService {
            ...
            public System.IAsyncResult BeginGet(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.WebSnapshot.WebSnapshot> specification, System.AsyncCallback callback, object asyncState) {
            ...
            public Smeedee.DomainModel.WebSnapshot.WebSnapshot[] EndGet(System.IAsyncResult result) {
                object[] _args = new object[0];
                Smeedee.DomainModel.WebSnapshot.WebSnapshot[] _result = ((Smeedee.DomainModel.WebSnapshot.WebSnapshot[])(base.EndInvoke("Get", _args, result)));
                return _result;
            }
            
            public System.IAsyncResult BeginSave(Smeedee.DomainModel.WebSnapshot.WebSnapshot[] webSnapshots, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = webSnapshots;
