...
// 
namespace Smeedee.Client.Framework.SL.UserRepositoryService {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface UserRepositoryServiceChannel : Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService, System.ServiceModel.IClientChannel {
    }
    ...
    public partial class GetCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        public System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb> Result {
            get {
                base.RaiseExceptionIfNecessary();
                return ((System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb>)(this.results[0]));
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class UserRepositoryServiceClient : System.ServiceModel.ClientBase<Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService>, Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService {
        ...
        System.IAsyncResult Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService.BeginGet(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.Users.Userdb> specification, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGet(specification, callback, asyncState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb> Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService.EndGet(System.IAsyncResult result) {
        ...
        private System.IAsyncResult OnBeginGet(object[] inValues, System.AsyncCallback callback, object asyncState) {
            Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.Users.Userdb> specification = ((Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.Users.Userdb>)(inValues[0]));
            return ((Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService)(this)).BeginGet(specification, callback, asyncState);
        }
        
        private object[] OnEndGet(System.IAsyncResult result) {
            System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb> retVal = ((Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService)(this)).EndGet(result);
            return new object[] {
                    retVal};
        }
        ...
        public void GetAsync(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.Users.Userdb> specification) {
            this.GetAsync(specification, null);
        }
        
        public void GetAsync(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.Users.Userdb> specification, object userState) {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        void Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService.EndSave(System.IAsyncResult result) {
        ...
        private object[] OnEndSave(System.IAsyncResult result) {
            ((Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService)(this)).EndSave(result);
            return null;
        }
        ...
        protected override Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService CreateChannel() {
            return new UserRepositoryServiceClientChannel(this);
        }
        
        private class UserRepositoryServiceClientChannel : ChannelBase<Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService>, Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService {
            
            public UserRepositoryServiceClientChannel(System.ServiceModel.ClientBase<Smeedee.Client.Framework.SL.UserRepositoryService.UserRepositoryService> client) : 
                    base(client) {
            }
            
            public System.IAsyncResult BeginGet(Smeedee.DomainModel.Framework.Specification<Smeedee.DomainModel.Users.Userdb> specification, System.AsyncCallback callback, object asyncState) {
            ...
            public System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb> EndGet(System.IAsyncResult result) {
                object[] _args = new object[0];
                System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb> _result = ((System.Collections.Generic.List<Smeedee.DomainModel.Users.Userdb>)(base.EndInvoke("Get", _args, result)));
                return _result;
            }
