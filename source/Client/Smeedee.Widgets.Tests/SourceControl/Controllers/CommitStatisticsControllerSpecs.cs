...
namespace Smeedee.Client.Widget.SourceControlTests.Controllers.CommitStatisticsControllerSpecs
{
    [TestFixture]
        ...
        public void Should_get_timespan_from_configrepo_if_settings_are_set()
        {
            ...
            Then(
                ...
                () => configRepositoryMock.Verify(
                    r => r.BeginGet(It.IsAny<ConfigurationByName>()), Times.AtLeastOnce()));
        }
    ...
    public class When_notified_to_refresh : Shared
    {
        ...
        public void assure_new_config_value_reloades_viewModel()
        {
            ...
            When("controller is notified to refresh", () =>
            {
