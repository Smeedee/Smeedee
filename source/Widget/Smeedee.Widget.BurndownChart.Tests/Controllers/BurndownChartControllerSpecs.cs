...
namespace APD.Client.Widget.BurndownChart.BurndownChartControllerSpecs
{
    public class Shared
    {
        ...
        protected static void CreateController()
        {
            ...
            controller = new BurndownChartController(new BurndownChartViewModel(), repositoryMock.Object, iNotifyWhenToRefreshMock.Object,
                                                     new NoUIInvokation(), BackgroundWorkerInvoker);
        }
    }

    public interface INotifyWhenToRefresh
    {
    }
