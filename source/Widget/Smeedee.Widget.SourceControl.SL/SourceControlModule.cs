...
{
    [Export(typeof(Slide))]
    public class SourceControlModule : Slide
    {
        private CheckInNotificationController _controller;
        ...
        public SourceControlModule()
        {
            ...
            var viewModel = new CheckInNotificationViewModel();
            View = new CheckInNotification();
            ...
            _controller = new CheckInNotificationController(viewModel, uiInvoker, timer, changesetRepository, userRepository, asyncClient, logger );
        }
    }
}