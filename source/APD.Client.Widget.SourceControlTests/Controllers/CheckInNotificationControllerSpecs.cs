...
namespace APD.Client.Widget.SourceControlTests.Controllers.CheckInNotificationControllerSpecs
{
    public class Shared
    {
        ...
        private static void CreateController()
        {
            ...
            controller = new CheckInNotificationController(repositoryMock.Object,
        ...
        public void Should_query_Changeset_repository_for_newest_changeset()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                scenario.When("notified to refresh", () =>
                                                     iNotifyWhenToRefreshMock.Raise(n => n.Refresh += null,
            ...
            Assure_ImplementationViolationException_is_thrown_if_Changeset_repository_return_a_null_reference()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                scenario.Then("assure ImplementationViolationException is thrown",
                              () => this.ShouldThrowException<ImplementationViolationException>(
