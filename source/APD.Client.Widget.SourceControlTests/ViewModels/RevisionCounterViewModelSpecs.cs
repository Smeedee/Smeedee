...
namespace APD.Client.Widget.SourceControlTests.ViewModels.RevisionCounterViewModelSpecs
{
    public class Shared
    {
        ...
        {
            revisionCounterViewModel = new RevisionCounterViewModel(new NoUIInvocation());
        };

        protected Context object_is_created_with_topCommitersViewModel = () =>
        {
            topCommitersViewModel = new TopCommitersViewModel(new NoUIInvocation());
            revisionCounterViewModel = new RevisionCounterViewModel(new NoUIInvocation(), topCommitersViewModel);
        };
    }
    ...
    public class When_notfied : Shared
    {
        ...
        public void should_reflect_changes_in_the_developers_collection()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                {
                    var codeCommiterViewModel = new CodeCommiterViewModel(new NoUIInvocation());
        ...
        public void should_reflect_changes_in_a_developers_number_of_commits()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                scenario.Then("the revision count should reflect the changes", () =>
                {
                    var codeCommiterViewModel1 = new CodeCommiterViewModel(new NoUIInvocation());
                    var codeCommiterViewModel2 = new CodeCommiterViewModel(new NoUIInvocation());
