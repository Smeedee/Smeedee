...
namespace APD.Client.Widget.SourceControlTests.ViewModels.TopCommitersViewModelSpecs
{
    public class Shared
    {
    ...
    public class When_ViewModel_is_spawned : Shared
    {
        ...
        public void Setup()
        {
            viewModel = new TopCommitersViewModel(new NoUIInvocation());
        }
        ...
        public void Assure_observers_are_notified_when_content_in_Developer_property_changes()
        {
            Scenario.StartNew(this, scenario =>
            {
                ...
                scenario.When("content in Developer property changes", () =>
                    viewModel.Developers.Add(new CodeCommiterViewModel(new NoUIInvocation())));
