...
namespace APD.Tests
{
    public class PropertyTester
    {
        ...
        {
            testObject.PropertyChanged += new PropertyChangedEventHandler(viewModel_PropertyChanged);
        ...
        {
            (sender as INotifyPropertyChanged).PropertyChanged -= new PropertyChangedEventHandler(viewModel_PropertyChanged);
        ...
        private static object ChangeEnumValue(object oldValue)
        {
            if (oldValue == null || oldValue.GetType().IsEnum == false)
                throw new ArgumentException("The olavalue needs to be an enum");
